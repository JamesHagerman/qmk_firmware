...
[_BASE] = LAYOUT_60_ansi_split_bs_rshift(
	...
	KC_LCTL,    KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(_LOWER), MO(_RAISE), KC_RCTL),
...
[_RAISE] = LAYOUT_60_ansi_split_bs_rshift(
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, XXXXXXX,
...
[_ADJUST] = LAYOUT_60_ansi_split_bs_rshift(
	KC_TRNS, EF_DEC,  EF_INC,  H1_DEC,  H1_INC,  H2_DEC,  H2_INC,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, BR_DEC,  BR_INC,  KC_TRNS, XXXXXXX,
